...
//print_text("enumdone\n");
    ...
    {
print_text("incomplisoin\n");
      retval |= DCD_IsoINIncomplete_ISR(pdev);
    }

    if (gintr_status.b.incomplisoout)
    {
print_text("incomplisoout\n");
...
if((status.d32 & 0xf0000000))
{
print_hex(status.d32);
}
